...
> [!NOTE]
> Recurring weekly hours start in Week 3. The sessions below are what's running until then. The Week 3 schedule will be announced on [Ed Discussion](communication.md).
...
The DLC is the Demco Learning Centre, room X150 in the ICICS/CS building. It's a big open room full of tables, shared with TAs from other CPSC courses, so the table number matters. Head for Table 1.

The easy way to find it: follow the smell of pho. The DLC is right next door to Pho Real, the Vietnamese counter in the ICICS X wing. If you've found the pho, you've found the DLC.
...
> [!TIP]
> The DLC is open to you as a study space even when nobody is holding hours there. It's a good place to work on a lab or the project with your group.

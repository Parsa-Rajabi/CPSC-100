...
Ed Discussion and office hours are the fastest way to get help. Reserve email for personal or confidential matters, and check [Course Communication](communication.md) for which address to use.

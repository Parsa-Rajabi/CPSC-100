...
| :--: | :----------- | :-- |
| 8 | Project introduced. Debug and annotate a Python program we provide. | Project 1 retrospective + iPeer 1, Thu Oct 29 |
| 9 | Convert Snap! to Python | Project 2A, Thu Nov 5 |
...
- The viva voce cannot be made up. Attending it is a passing requirement.
- If a serious or unexpected circumstance prevents you from attending, use the [academic concession](syllabus.md#academic-concessions) process immediately, not afterwards.
...
| Situation | Result |
| :-------- | :----- |
| A working program you cannot explain | Marked on the explanation, not the program |
...
- Complete and annotate a working Snap! program.
- Tie it to course concepts from a provided list: bias, privacy, surge pricing, accessibility, and others.
- The annotation is the assessed part, not whether the program runs.
- Practice in Lab 6, Week 8, on a program we hand you. It is deliberately not your project program.

## Part B: Snap! to Python Translation

Group. Due Thursday Nov 19 at 11:59pm.
...
- Not a memory test. It assesses whether you can explain your own work.
- Lab 8 has you programming with AI, and this exam is about the code you handed in. If a tool wrote something you cannot explain, this is where it surfaces.

## Related

- [Project](project.md) - bands, group process, integrity, AI
- [Project 1: Signal or Noise?](project-1.md)
- [Labs](labs.md) - Labs 6 to 10 feed this project
- [Quizzes](quizzes.md) - how the booking system works
